...
struct SignatureSkepuHelp
{
  std::string type;
  std::string name;
};

struct SkepuArguments
{
  std::string arity;
  std::vector<std::string> retValue;
  std::string IndexND;
  std::string randomArg;
  std::vector<std::string> element_wise;
  std::vector<std::string> random_access;
  ...
  std::string to_string() const
  {
    ...
    tmp += "IndexND: " + IndexND + " | ";
    tmp += "randomArg: " + randomArg + " element_wise: ";
    for(auto elem : element_wise)
    {
      tmp += elem + ", ";
    }
    tmp += " | ";
